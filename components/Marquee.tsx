    ...
    <div className="w-full h-full ">
      <div className="w-full h-full my-12 md:my-24 ">
        <div className="w-full h-full flex flex-col  justify-center items-center md:py-14 pt-6 ">
          <h1 className="text-xl text-center md:text-4xl font-bold text-black leading-tight">
            Our Services
          </h1>
          <p className="text-center text-zinc-600 text-sm py-4 font-medium  md:text-lg tracking-tight">
      ...
      <div className="w-full h-full my-12 md:my-24 ">
        ...
        <div className="w-full h-full flex flex-col justify-center items-center md:py-14 pt-6">
          <h1 className="text-xl text-center md:text-4xl font-bold text-black leading-tight">
            Our Solutions That Drive Growth
          </h1>
          <p className="text-center text-zinc-600 text-sm py-4 font-medium  md:text-lg tracking-tight">
            Discover how our solutions can help your business grow and succeed
...
const service = [
  ...
  },
  {
    ...
    description:
      "Transform your data into actionable insights for your business decisions.",
...
export const testimonials = [
  {
    name: "John Doe",
    testimonial:
      "Nixsoft's cloud solutions transformed our business operations. Highly recommended!",
    img: "/cybersecurity.jpg",
  },
  {
    name: "Jane Smith",
    testimonial:
      "Their cybersecurity team is top-notch. We feel much more secure now.",
  },
  {
    name: "Michael Johnson",
    testimonial:
      "The software development services exceeded our expectations. Great work!",
  },
];
