...
const slides = [
  {
    background: "url('https://plus.unsplash.com/premium_photo-1712254285399-f5f181730830?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
    title: "Achieve your CX goals with Unified Observability",
    description: "Get unparalleled visibility into your infrastructure."
  },
  {
    background: "url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')",
    title: "Real-time Analytics for Smart Decisions",
    description: "Instant insights powered by AI-driven analytics."
  },
  {
    background: "url('https://images.unsplash.com/photo-1531403009284-440f080d1e12?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')",
  ...
  return (
    <div className="w-full h-full">
      <div
        ...
        style={{
          backgroundImage: "url('https://plus.unsplash.com/premium_photo-1712254285399-f5f181730830?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
