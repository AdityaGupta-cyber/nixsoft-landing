...
const NixSoftHero = () => {
  return (
    <div className="relative w-full h-96 bg-indigo-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 h-full flex flex-col justify-center">
        <h1 className="text-white text-4xl md:text-5xl font-bold mb-2">
          Modernize Your<br />
          IT Infrastructure With<br />
          <span className="text-cyan-400">Cloud & Virtualization Services</span>
        </h1>
        
        <p className="text-white text-lg md:text-xl max-w-xl mb-8">
          Accelerate innovation with new-age platforms. Get the 
          experts to consult, design, deploy, automate, and deliver.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button className="px-8 py-3 bg-transparent border-2 border-white text-white font-medium rounded hover:bg-white hover:bg-opacity-10 transition-colors">
            Get a Quote
          </button>
        </div>
      </div>
