...
const heroContent = {
  ...
  paragraph1: "At Nixsoft Technologies, we specialize in delivering comprehensive cloud and virtualization solutions that accelerate your business agility, optimize resource usage, and maximize efficiency.",
  paragraph2: "Our expertise spans leading cloud platforms and virtualization technologies, empowering your organization to operate seamlessly across environments.",
  buttons: [
    {
      text: "Our Services",
      primary: true,
