...
import { Cloud, Server, Database, Network, ArrowRight, Lightbulb, Settings, Layers, Globe2 } from "lucide-react";

const heroContent = {
  badge: "Consulting Services",
  title: "IT Consulting & Strategy",
  paragraph1: "At Nixsoft Technologies, we partner with organizations to navigate complex IT challenges and design sustainable, future-ready strategies.",
  paragraph2: "Our consulting services are tailored to align technology with business objectives, improve efficiency, reduce costs, and drive digital transformation across the enterprise.",
  buttons: [
    {
      text: "Our Services",
      primary: true,
  ...
  serviceCards: [
    { icon: "Lightbulb", title: "Strategic Planning" },
    { icon: "Settings", title: "IT Optimization" },
    { icon: "Layers", title: "Digital Transformation" },
    { icon: "Globe2", title: "Enterprise Architecture" }
  ]
};
